...
/*
 * Function checks "flipped" cards for a match; if matched, cards get added to activeDeck array;
 *   + also, sets timeOut function for when cards are OK to be "flipped" back if no match found.
